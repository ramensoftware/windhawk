...
//! (`window`), what keeps tao's taskbar registration from pinning or
//! deadlocking the UI thread (`taskbar_list`), and what a fatal window failure
//! can be told about itself
