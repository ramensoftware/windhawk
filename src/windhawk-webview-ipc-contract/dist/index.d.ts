 ...
 */
export declare const WEBVIEW_IPC_CONTRACT_VERSION = "1.13.0";
/**
 ...
 */
export declare const ALL_VERSIONS = "*";
/**
 ...
 */
export declare function parseSuppression(stored: string): UpdateSuppression | null;
/**
 ...
 */
export declare function formatSuppression(suppression: UpdateSuppression): string;
/**
 ...
 */
export declare function suppressesUpdateOffer(stored: string, latest: string): boolean;
/**
 ...
 */
export declare function isValidSuppression(value: string): boolean;
