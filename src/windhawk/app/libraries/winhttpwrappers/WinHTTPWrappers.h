...
VC 2013. PJN / 08-06-2014 1. Updated copyright details.
                          2.
Updated CAsyncWinHTTPDownloader::Initialize to allow the dwShareMode parameter of
                          the ATL::CAtlFile::Create call for the file instances
to be download and uploaded to  be customized. The default value
for the share mode is now 0 instead of FILE_SHARE_READ. 
